    ...
    <PageLayout title={t.title} subtitle={t.subtitle}>
      <div style={{ maxWidth:"480px" }}>
        ...
        <a href="mailto:mathastruc@gmail.com?subject=Reference%20Request" className="btn-dark"
          style={{ display:"inline-flex",alignItems:"center",gap:"8px",padding:"10px 20px",background:"var(--color-text)",color:"var(--color-bg)",borderRadius:"var(--radius-full)",fontSize:"var(--text-sm)",fontWeight:500,textDecoration:"none",letterSpacing:"-0.01em" }}>
          {t.button}
        </a>
      </div>
    </PageLayout>
