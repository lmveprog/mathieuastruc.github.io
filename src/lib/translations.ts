...
export const T: Record<Lang, Translation> = {
  en: {
    ...
    career: {
      ...
      experiences: [
        { period: "Mar 2026\nSep 2026", company: "Airbus Helicopters", location: "France", role: "Engineering Intern — Final Year (PFE)", description: "Final year engineering internship applying AI and data engineering expertise", current: true, logo: "/images/career/airbus.webp", logoSize: { w: 120, h: 36 } },
        { period: "Jun 2025\nAug 2025", company: "NTNU", location: "Gjøvik, Norway · EduTech Lab", role: "Intern Researcher — Social Robotics", bullets: ["Real-time gesture-based interaction with the NAO social robot.", "Conversational assistant with the Reachy robot — optimized response times, dialogue flow and human-in-the-loop interruption handling.", "Robot–Robot Interaction (RRI) loop enabling NAO and Reachy to communicate autonomously.", "Expected to lead to two scientific publications."], photo: "/images/career/ntnu.jpg" },
        { period: "Jan 2025\nMay 2025", company: "COMAT Specific", location: "Angers, France · Aerospace Industry", role: "OCR / Computer Vision Project", bullets: ["Led a hybrid academic–industry project applying computer vision and deep learning to digitalise handwritten 2D sketches.", "Built an OCR pipeline (Python, doctr, OpenCV, CNNs) extracting angles, RAL codes and finishes, exporting structured JSON/PDF data.", "Agile methodology: dataset preprocessing, model training, error analysis (GitHub, Trello, weekly stakeholder feedback)."], logo: "/images/career/comat.png", logoSize: { w: 120, h: 40 } },
        { period: "2024\n3 months", company: "Banque de France", location: "Poitiers, France", role: "Data Engineer Junior", description: "Built web scraping pipelines with Python and Selenium to retrieve data from ElasticSearch platforms, feeding RAG AI models. Explored NLP including ASR (speech-to-text) and OCR for text recognition.", logo: "/images/career/bdf.png", logoSize: { w: 110, h: 36 } },
  ...
  fr: {
    ...
    career: {
      ...
      experiences: [
        { period: "Mar 2026\nSep 2026", company: "Airbus Helicopters", location: "France", role: "Stagiaire Ingénieur — Stage de Fin d'Études (PFE)", description: "Stage de fin d'études appliquant l'expertise en IA et ingénierie des données", current: true, logo: "/images/career/airbus.webp", logoSize: { w: 120, h: 36 } },
        { period: "Jun 2025\nAoû 2025", company: "NTNU", location: "Gjøvik, Norvège · EduTech Lab", role: "Chercheur Stagiaire — Robotique Sociale", bullets: ["Interaction gestuelle en temps réel avec le robot social NAO.", "Assistant conversationnel avec le robot Reachy — temps de réponse optimisés, gestion du flux de dialogue et interruption humain-dans-la-boucle.", "Boucle d'Interaction Robot-Robot (IRR) permettant à NAO et Reachy de communiquer de façon autonome.", "Devrait mener à deux publications scientifiques."], photo: "/images/career/ntnu.jpg" },
        { period: "Jan 2025\nMai 2025", company: "COMAT Specific", location: "Angers, France · Industrie Aérospatiale", role: "Projet OCR / Vision par Ordinateur", bullets: ["Pilotage d'un projet hybride académique-industriel appliquant la vision par ordinateur et le deep learning pour numériser des croquis 2D manuscrits.", "Développement d'un pipeline OCR (Python, doctr, OpenCV, CNNs) extrayant angles, codes RAL et finitions, exportant des données JSON/PDF structurées.", "Méthodologie Agile : prétraitement des données, entraînement de modèles, analyse des erreurs (GitHub, Trello, retours hebdomadaires)."], logo: "/images/career/comat.png", logoSize: { w: 120, h: 40 } },
        { period: "2024\n3 mois", company: "Banque de France", location: "Poitiers, France", role: "Data Engineer Junior", description: "Développement de pipelines de web scraping avec Python et Selenium pour récupérer des données depuis des plateformes ElasticSearch, alimentant des modèles IA RAG. Exploration du NLP incluant l'ASR et l'OCR.", logo: "/images/career/bdf.png", logoSize: { w: 110, h: 36 } },
